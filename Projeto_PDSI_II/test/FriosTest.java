 ...
 */
public class FriosTest extends TestCase {

    Cadastro_Alimento p, edit;
    DAOFrios dao = new DAOFrios();
    ...
    @Before
    public void setUp() {
        p = new Cadastro_Alimento("ovo", "Sadia", 12.0, 25.70);
    }
...
// TESTES ATUALIZAR ------------------------------------------------------------
    ...
    public void testAtualizarSemTipo() {
        ArrayList<Cadastro_Alimento> aux = dao.listarcada(3);
        edit = aux.get(0);
        edit.setTipo("");
